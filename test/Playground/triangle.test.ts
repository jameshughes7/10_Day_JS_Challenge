import { Triangle } from '../../src/Playground/triangle';
...
describe('Triangle', () => {
  describe('equilateral triangle', () => {
    it('all sides are equal', () => {
      ...
      expect(triangle.isEquilateral()).to.eq(true);
    });

    it('any side is unequal', () => {
      const triangle = new Triangle(2, 3, 2);
      expect(triangle.isEquilateral()).to.eq(false);
    });
  ...
  describe('isosceles triangle', () => {
    it('last two sides are equal', () => {
      ...
      expect(triangle.isIsosceles()).to.eq(true);
    });
    ...
    it('no sides are equal', () => {
      ...
      expect(triangle.isIsosceles()).to.eq(false);
    });
  ...
  describe('scalene triangle', () => {
    it('no sides are equal', () => {
      const triangle = new Triangle(5, 4, 6);
      expect(triangle.isScalene()).to.eq(true);
    });

    it('all sides are equal', () => {
      const triangle = new Triangle(4, 4, 4);
      expect(triangle.isScalene()).to.eq(false);
    });
